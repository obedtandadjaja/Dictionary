 ...
 */
public class EnglishKorean extends Fragment {
    ...
    {
        View rootView = inflater.inflate(R.layout.english_korean, container, false);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<Translation> translation_array_long = translation_data_source.getEnKrTranslation(word_search.getText().toString());
