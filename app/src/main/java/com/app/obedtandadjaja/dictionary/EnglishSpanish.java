 ...
 */
public class EnglishSpanish extends Fragment {
    ...
    {
        View rootView = inflater.inflate(R.layout.english_spanish, container, false);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<Translation> translation_array_long = translation_data_source.getEnSpTranslation(word_search.getText().toString());
