 ...
 */
public class IndonesianEnglish extends Fragment{
    ...
    {
        View rootView = inflater.inflate(R.layout.indonesian_english, container, false);
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayList<Translation> translation_array_long = translation_data_source.getIndEngTranslationLong(word_search.getText().toString());
                ArrayList<Translation> translation_array_brief = translation_data_source.getIndEngTranslationBrief(word_search.getText().toString());
